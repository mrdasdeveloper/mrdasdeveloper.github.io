...
australia_cities = [
    {
        ...
        "ecosystem": "Fintech, global tech headquarters, and SaaS hubs",
        "focus_title": "Fintech & SaaS Innovation",
        "focus_desc": "Highly scalable platforms powering Sydney's massive fintech and enterprise ecosystem.",
        "hero_desc": "fintech innovators, SaaS startups, and enterprise operations",
        "pricing_market": "Sydney Agency"
    },
    {
        "name": "Melbourne", "slug": "melbourne",
        "ecosystem": "Biotech, edtech, and emerging software development",
        "focus_title": "Biotech & EdTech IT Systems",
        "focus_desc": "Robust enterprise software tailored for Melbourne's strong biotech and edtech hiring demands.",
        "hero_desc": "biotech labs, education technology, and software hubs",
        "pricing_market": "Melbourne Agency"
    },
    {
        "name": "Brisbane", "slug": "brisbane",
        "ecosystem": "Agtech, enterprise software, and growing tech ecosystems",
        "focus_title": "Agtech & Enterprise Platforms",
        "focus_desc": "High-performance software engineering solutions tailored for Brisbane's growing agtech sectors.",
        "hero_desc": "agtech operations and emerging enterprise networks",
        "pricing_market": "Brisbane Agency"
    }
]
...
for tpl in templates:
    ...
    for city in australia_cities:
        ...
        content = re.sub(r'<title>.*?</title>', f'<title>Hire Ramesh Kumar Das — Top {tpl["role"]} in {city["name"]} & Australia</title>', content)
        content = re.sub(r'<meta name="description" content=".*?" />', f'<meta name="description" content="Hire Ramesh Kumar Das, Top {tpl["role"]} in {city["name"]} & Australia. Building scalable systems for {city["hero_desc"]}." />', content)
        
        # Meta Keywords
        content = re.sub(r'<meta name="keywords" content=".*?" />', f'<meta name="keywords" content="hire {tpl["kw_prefix"]} {city["name"]}, {tpl["kw_prefix"]} for hire Australia, freelance developer {city["name"]}, Next.js developer {city["name"]}, remote developer Australia, Agentic AI developer, FastAPI expert Australia, Ramesh Kumar Das" />', content)
        ...
        content = re.sub(r'<meta property="og:title" content=".*?" />', f'<meta property="og:title" content="Hire Ramesh Kumar Das — Top {tpl["role"]} in {city["name"]} & Australia" />', content)
        ...
        # Schema Area Served
        content = content.replace('"areaServed":"Worldwide"', f'"areaServed":"{city["name"]}, Australia"')
        
        # Hero Adjustments
        content = content.replace('Available for Hire — Remote', 'Available for Hire — Remote (AEST / Australia Timezone)')
        content = content.replace(f'<h1 id="hero-heading">{tpl["hero_original"]}</h1>', f'<h1 id="hero-heading">Top {tpl["role"]}<br>for {city["name"]} & Australia</h1>')
        
        # Add focus chip
        content = content.replace('<span class="chip neutral">Nepal &nbsp;·&nbsp; Remote</span>', f'<span class="chip neutral">{city["name"]} / AEST Focus</span>')
...
# Now generate the Australia Hub page
hub_content = """
<main class="main">
  <section class="section">
    <div class="ps-inner" style="max-width: 1000px; margin: 0 auto; padding: 40px 20px;">
      <h1 style="font-size: 3rem; margin-bottom: 20px;">Hire Tech Talent in Australia 🇦🇺</h1>
      <p style="font-size: 1.2rem; color: var(--dim); margin-bottom: 40px; max-width: 800px;">
        Australia is a growing powerhouse for SaaS and Fintech innovation. We provide elite, remote-first Full-Stack, AI, and Backend developers aligned with Australian Eastern Standard Time (AEST). Explore our specialized hubs tailored for Australia's top tech cities.
      </p>
...
h = header_match.replace("<title>Hire Ramesh Kumar Das — Senior Full-Stack Developer | React, Next.js, Node.js, FastAPI</title>", "<title>Hire Tech Talent in Australia — Developers Hub</title>")
h = h.replace('<meta name="description" content="Senior Full-Stack Developer with 6.5+ years. Expert in React.js, Next.js, Node.js, FastAPI. Available for remote hire." />', '<meta name="description" content="Hire elite remote developers specialized for the Australian market. AI, Full-Stack, FastAPI, and Backend engineers available on AEST." />')

full_html = h + hub_content + footer_match
with open(os.path.join(output_dir, "hire-developers-australia.html"), "w") as f:
    f.write(full_html)
print("Generated hire-developers-australia.html")
