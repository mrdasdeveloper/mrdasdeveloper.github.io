...
uk_cities = [
    {
        ...
        "ecosystem": "Fintech, AI startups, media, and enterprise software",
        "focus_title": "Fintech & Enterprise SaaS",
        "focus_desc": "Highly scalable platforms powering London's massive fintech and AI ecosystem.",
        "hero_desc": "fintech innovators, AI startups, and enterprise operations",
        "pricing_market": "London Agency"
    },
    {
        "name": "Manchester", "slug": "manchester",
        "ecosystem": "E-commerce, digital media, and growing tech hubs",
        "focus_title": "E-Commerce & Digital Media Platforms",
        "focus_desc": "Robust enterprise software tailored for Manchester's strong e-commerce and digital hiring demands.",
        "hero_desc": "e-commerce brands and major digital media hubs",
        "pricing_market": "UK Agency"
    },
    {
        "name": "Cambridge", "slug": "cambridge",
        "ecosystem": "Deep tech, biotech, AI research, and semiconductor",
        "focus_title": "Deep Tech & AI Research",
        "focus_desc": "High-performance software engineering solutions tailored for Cambridge's growing AI and deep tech sectors.",
        "hero_desc": "research centers and emerging AI/biotech startups",
        "pricing_market": "UK Agency"
    }
]
...
for tpl in templates:
    ...
    for city in uk_cities:
        ...
        content = re.sub(r'<title>.*?</title>', f'<title>Hire Ramesh Kumar Das — Top {tpl["role"]} in {city["name"]} & UK</title>', content)
        content = re.sub(r'<meta name="description" content=".*?" />', f'<meta name="description" content="Hire Ramesh Kumar Das, Top {tpl["role"]} in {city["name"]} & UK. Building scalable systems for {city["hero_desc"]}." />', content)
        ...
        # Hero Adjustments
        content = content.replace('Available for Hire — Remote', 'Available for Hire — Remote (GMT / UK Timezone)')
        content = content.replace(f'<h1 id="hero-heading">{tpl["hero_original"]}</h1>', f'<h1 id="hero-heading">Top {tpl["role"]}<br>for {city["name"]} & UK</h1>')
        
        # Add focus chip
        content = content.replace('<span class="chip neutral">Nepal &nbsp;·&nbsp; Remote</span>', f'<span class="chip neutral">{city["name"]} / UK Focus</span>')
...
# Now generate the UK Hub page
hub_content = """
<main class="main">
  <section class="section">
    <div class="ps-inner" style="max-width: 1000px; margin: 0 auto; padding: 40px 20px;">
      <h1 style="font-size: 3rem; margin-bottom: 20px;">Hire Tech Talent in the UK 🇬🇧</h1>
      <p style="font-size: 1.2rem; color: var(--dim); margin-bottom: 40px; max-width: 800px;">
        The United Kingdom is Europe's leading hub for fintech and AI. We provide elite, remote-first Full-Stack, AI, and Backend developers aligned with UK Time (GMT/BST). Explore our specialized hubs tailored for the UK's top tech cities.
      </p>
...
h = header_match.replace("<title>Hire Ramesh Kumar Das — Senior Full-Stack Developer | React, Next.js, Node.js, FastAPI</title>", "<title>Hire Tech Talent in the UK — Developers Hub</title>")
h = h.replace('<meta name="description" content="Senior Full-Stack Developer with 6.5+ years. Expert in React.js, Next.js, Node.js, FastAPI. Available for remote hire." />', '<meta name="description" content="Hire elite remote developers specialized for the UK market. AI, Full-Stack, FastAPI, and Backend engineers available on GMT/BST." />')

full_html = h + hub_content + footer_match
with open(os.path.join(output_dir, "hire-developers-uk.html"), "w") as f:
    f.write(full_html)
print("Generated hire-developers-uk.html")
