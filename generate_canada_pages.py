...
canada_cities = [
    {
        ...
        "ecosystem": "AI research hubs, tech startups, and financial services",
        "focus_title": "AI Research & Fintech Platforms",
        "focus_desc": "Highly scalable platforms powering Toronto's massive AI and fintech ecosystem.",
        "hero_desc": "AI research hubs, fintech startups, and enterprise operations",
        "pricing_market": "Toronto Agency"
    },
    {
        "name": "Vancouver", "slug": "vancouver",
        "ecosystem": "Gaming, visual effects, software development, and green tech",
        "focus_title": "Software Innovation & Gaming Tech",
        "focus_desc": "Robust enterprise software tailored for Vancouver's strong digital media and tech hiring demands.",
        "hero_desc": "digital media companies and software innovators",
        "pricing_market": "Vancouver Agency"
    },
    {
        "name": "Montreal", "slug": "montreal",
        "ecosystem": "Deep learning, gaming, and AI development",
        "focus_title": "Deep Learning & AI Development",
        "focus_desc": "High-performance software engineering solutions tailored for Montreal's growing AI sectors.",
        "hero_desc": "deep learning labs and major AI startups",
        "pricing_market": "Montreal Agency"
    }
]
...
for tpl in templates:
    ...
    for city in canada_cities:
        ...
        content = re.sub(r'<title>.*?</title>', f'<title>Hire Ramesh Kumar Das — Top {tpl["role"]} in {city["name"]} & Canada</title>', content)
        content = re.sub(r'<meta name="description" content=".*?" />', f'<meta name="description" content="Hire Ramesh Kumar Das, Top {tpl["role"]} in {city["name"]} & Canada. Building scalable systems for {city["hero_desc"]}." />', content)
        
        # Meta Keywords
        content = re.sub(r'<meta name="keywords" content=".*?" />', f'<meta name="keywords" content="hire {tpl["kw_prefix"]} {city["name"]}, {tpl["kw_prefix"]} for hire Canada, freelance developer {city["name"]}, Next.js developer {city["name"]}, remote developer Canada, Agentic AI developer, FastAPI expert Canada, Ramesh Kumar Das" />', content)
        ...
        content = re.sub(r'<meta property="og:title" content=".*?" />', f'<meta property="og:title" content="Hire Ramesh Kumar Das — Top {tpl["role"]} in {city["name"]} & Canada" />', content)
        ...
        # Schema Area Served
        content = content.replace('"areaServed":"Worldwide"', f'"areaServed":"{city["name"]}, Canada"')
        
        # Hero Adjustments
        content = content.replace('Available for Hire — Remote', 'Available for Hire — Remote (EST / PST / Canada Timezones)')
        content = content.replace(f'<h1 id="hero-heading">{tpl["hero_original"]}</h1>', f'<h1 id="hero-heading">Top {tpl["role"]}<br>for {city["name"]} & Canada</h1>')
        
        # Add focus chip
        content = content.replace('<span class="chip neutral">Nepal &nbsp;·&nbsp; Remote</span>', f'<span class="chip neutral">{city["name"]} / Canada Focus</span>')
...
# Now generate the Canada Hub page
hub_content = """
<main class="main">
  <section class="section">
    <div class="ps-inner" style="max-width: 1000px; margin: 0 auto; padding: 40px 20px;">
      <h1 style="font-size: 3rem; margin-bottom: 20px;">Hire Tech Talent in Canada 🇨🇦</h1>
      <p style="font-size: 1.2rem; color: var(--dim); margin-bottom: 40px; max-width: 800px;">
        Canada is a global leader in AI research and software innovation. We provide elite, remote-first Full-Stack, AI, and Backend developers aligned with North American Timezones (EST/PST). Explore our specialized hubs tailored for Canada's top tech cities.
      </p>
...
h = header_match.replace("<title>Hire Ramesh Kumar Das — Senior Full-Stack Developer | React, Next.js, Node.js, FastAPI</title>", "<title>Hire Tech Talent in Canada — Developers Hub</title>")
h = h.replace('<meta name="description" content="Senior Full-Stack Developer with 6.5+ years. Expert in React.js, Next.js, Node.js, FastAPI. Available for remote hire." />', '<meta name="description" content="Hire elite remote developers specialized for the Canadian market. AI, Full-Stack, FastAPI, and Backend engineers available on EST/PST." />')

full_html = h + hub_content + footer_match
with open(os.path.join(output_dir, "hire-developers-canada.html"), "w") as f:
    f.write(full_html)
print("Generated hire-developers-canada.html")
